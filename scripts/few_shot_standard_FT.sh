...
output_dir=$main_dir/out/hf/few_shot/$dataset/$model_name_or_path/shot${k_shot}/standard_FT/${seed}/bs${batch_size}_lr${lr}
...
python $main_dir/hf/main.py \
  ...
  --data_seed ${data_seed} 2>&1 | tee ${output_dir}/log.out
fi
